...
public class EngineCooledCombustion extends Engine {
	...
	public EngineCooledCombustion(TileEngine engine) {
		super(engine);
	...
	public String getTextureFile() {
		return "/gfx/base_cooled_combustion.png";
	}
	...
	public void update() {
		...
		if (!tile.isRedstonePowered && heat>=10) heat -= 10;
	}
