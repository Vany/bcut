...
public class GuiCooledCombustionEngine extends GuiEngine {

	public GuiCooledCombustionEngine(InventoryPlayer inventoryplayer, TileEngine tileEngine) {
	...
	protected void drawGuiContainerForegroundLayer() {
		...
		String title = "Cooled combustion engine";
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
		int i = mc.renderEngine.getTexture("/gfx/cooled_combustion_engine_gui.png");
